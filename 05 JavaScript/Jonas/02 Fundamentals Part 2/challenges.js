...
// the corresponding tip, calculated based on the rules above (you can check out the code from first tip calculator challenge if you need to).
...
const calcAverageForArray = function (arr) {
  let sum = 0;
...
console.log(calcAverageForArray([2, 4, 6]));
console.log(calcAverageForArray(Bills));
console.log(calcAverageForArray(Tips));
console.log(calcAverageForArray(Total));
