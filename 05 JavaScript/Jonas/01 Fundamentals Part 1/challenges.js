...
let massMark = 78;
let heightMarkt = 1.69;
const markBMI = (massMark / heightMarkt ** 2).toFixed(2);

let massJohn = 92;
let heightJohn = 1.95;
const johnBMI = (massJohn / (heightJohn * heightJohn)).toFixed(2);
...
// Data Bonus 2: Dolphins score 97, 112 and 81. Koalas score 109, 95 and 86
