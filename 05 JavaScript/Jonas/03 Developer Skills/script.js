"use strict"; // Remember, we're gonna use strict mode in all scripts now!

// How to use Google, StackOverFlow and MDN.
...
const temperaturesOne = [3, -2, -6, -10, "error", 9, 13, 17, 15, 14, 9, 5];
const temperaturesTwo = [5, 3, 4, 1, -1, 27, 19, 24, 29, 35];
...
const randomArray = calcTempAmplitude([2, 3, 4], [-1, 8, 5]);
